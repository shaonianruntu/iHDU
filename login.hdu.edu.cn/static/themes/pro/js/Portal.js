    ...
    function Portal(config) {
        ...
        _request.set(_assertThisInitialized(_this), {
            ...
            value: function value(obj) {
                ...
                var url = "http://login.hdu.edu.cn"+obj.url
                ...
                $.ajax({
                    ...
                    headers: function () {
                        ...
                        console.debug('type:',obj.type)
                        console.debug('dataType:',obj.dataType)
                        console.debug('data:',obj.params)
                        console.groupEnd()
                        return headers;
                    }(),
                    success: function success(res) {
                ...
                setTimeout(function () {
                    _this3.ajax.jsonp({
                        ...
                        success: function success(res) {
                            ...
                            $("#real-name").html(_this3.userInfo.username)

$(function () {
    ...
    $(".download-container .panel-row-item").click(function () {
        ...
        var target = '';
        if (action === 'win')     target = '/download/clients/setup.exe';
        if (action === 'mac')     target = '/download/clients/setup.dmg';
        if (action === 'android') target = '/download/clients/setup.apk';
    ...
    $(".show-notice").click(function () {
        $(".convention").addClass("show");
    })

    // 点击图标显示图片信息
    $(".show-pic").click(function () {
        $(".pic-info").addClass("show");
        $(".tip").removeClass("show");
    })

    // 点击关闭按钮隐藏
    $(".close-notice").click(function (){
        $(".convention").removeClass("show");
    })
    $(".close-pic").click(function (){
        $(".pic-info").removeClass("show");
    })
